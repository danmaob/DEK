...
2. Resolve open questions with the stakeholder where possible; where
   not possible, record the assumption explicitly.
3. Draft user stories with acceptance criteria
   (`user-stories-acceptance-criteria`, `templates/user-story-template.md`).
4. Save the requirements note and stories as project files.

## Exit criteria
At least one user story exists with acceptance criteria a reader who
wasn't in the conversation could act on unambiguously.
